        ...
        for product in state.order_depths.keys():
            if product == 'PEARLS':
                ...
                if state.timestamp >= start_trading:
                    ...
                    print("PEARLS", current_position, "BUY VOLUME", -best_ask_volume-open_ask_volume, "SELL VOLUME", -best_bid_volume-open_bid_volume)
            ...
            if product == 'BANANAS':
                ...
                if state.timestamp >= start_trading:
                    ...
                    print("BANANAS", current_position, "BUY VOLUME", -best_ask_volume-open_ask_volume, "SELL VOLUME", -best_bid_volume-open_bid_volume)
                result[product] = orders
